...
## Free Acceptance Test Template

Use this when a buyer needs a proof-first checklist before accepting AI coding-agent output.

| Area | Acceptance Note |
| --- | --- |
...
| Acceptance Gate | Objective, scope, behavior, regression, security, cost, handoff |
| Hold Rule | Hold if proof is missing, indirect, stale, or out of scope |
